                            ...
                            <!-- <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample"> -->
                                <!-- <div class="card-body"> -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select class="col-10" id="nsong" name="#songs" data-placeholder="Choose a Language..." onchange="songs(this.value);" style="margin-left:30px;">
